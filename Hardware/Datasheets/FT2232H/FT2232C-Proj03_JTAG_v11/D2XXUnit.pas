...
TFT_program_data = record
       ...
       Description : Pointer;  	// "USB HS Serial Converter"
       SerialNumber : Pointer; 	// "FT000001" if fixed, or NULL
...
//  Deposit for Get latency timer
    ...
    Description :  array [0..63] of byte;  	// "USB HS Serial Converter"
    SerialNumber :  array [0..63] of byte; 	// "FT000001" if fixed, or NULL
...
//Function Get_USB_Device_LatencyTimer(var Latency : byte) : FT_Result ;
//Begin
//Get_USB_Device_LatencyTimer := FT_GetLatencyTimer(FT_Handle,@Latency);
//End;
Function Get_USB_Device_LatencyTimer : FT_Result ;
Begin
